...
legend('solitary uniform','combined uniform','solitary patched','combined patched');
hTitle = title('Comparison of performance of solitary robots vs combined roles in high density uniform and (big) patched environments.');
