...
hTitle = title('Comparison of performance of solitary robots vs combined roles in low density uniform and (small) patched environments while using odometry.');
