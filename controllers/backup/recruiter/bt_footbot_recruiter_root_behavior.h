#ifndef CBTFootbotRecruiterRootBehavior_H_
#define CBTFootbotRecruiterRootBehavior_H_
...
class CBTFootbotRecruiterRootBehavior: public CCI_Behavior<CCI_FootBotState> , public FSM<std::string> {

#define PICKUP_TIME 20
...
public:
	...
	CBTFootbotRecruiterRootBehavior(CCI_RobotData<CCI_FootBotState>* c_robot_data);
	virtual ~CBTFootbotRecruiterRootBehavior();
	...
	inline bool IsPickingUp() const {return m_sStateData.State == SStateData::STATE_SIGNAL_AND_PICK_UP;}
...
#endif /* CBTFootbotRecruiterRootBehavior_H_ */
