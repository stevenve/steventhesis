#ifndef CBTFootbotCombinedRootBehavior_H_
#define CBTFootbotCombinedRootBehavior_H_
...
class CBTFootbotCombinedRootBehavior: public CCI_Behavior<CCI_FootBotState> , public FSM<std::string> {
...
public:
	...
	CBTFootbotCombinedRootBehavior(CCI_RobotData<CCI_FootBotState>* c_robot_data, TConfigurationNode& t_tree);
...
#endif /* CBTFootbotCombinedRootBehavior_H_ */
