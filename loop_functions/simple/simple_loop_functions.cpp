#include "simple_loop_functions.h"
...
CSimpleLoopFunctions::CSimpleLoopFunctions() :
...
void CSimpleLoopFunctions::Init(TConfigurationNode& t_node) {
   try {
...
void CSimpleLoopFunctions::Reset() {
   /* Distribute uniformly the items in the environment */
...
void CSimpleLoopFunctions::Destroy() {
	/* Close the file */
	   m_cOutput.close();
}
...
void CSimpleLoopFunctions::PreStep() {
   ...
   for(CSpace::TMapPerType::iterator it = m_cFootbots.begin();
      ...
      /* Get state data */
      CBTFootbotRandomForagingController::SStateData* sStateData = &cController.GetStateData();
...
CColor CSimpleLoopFunctions::GetFloorColor(const CVector2& c_position_on_plane) {
...
bool CSimpleLoopFunctions::InNest(const CVector2& pos){
...
REGISTER_LOOP_FUNCTIONS(CSimpleLoopFunctions, "simple_loop_functions")
