#include "combined_loop_functions.h"
...
CCombinedLoopFunctions::CCombinedLoopFunctions() :
...
void CCombinedLoopFunctions::generateUniformFoodPatch(){
...
void CCombinedLoopFunctions::Reset() {
	//TODO fix
...
void CCombinedLoopFunctions::Destroy() {
	/* Close the file */
	m_cOutput.close();
}
...
CColor CCombinedLoopFunctions::GetFloorColor(const CVector2& c_position_on_plane) {
...
REGISTER_LOOP_FUNCTIONS(CCombinedLoopFunctions, "combined_loop_functions")
