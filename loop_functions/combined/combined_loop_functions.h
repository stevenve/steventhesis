#ifndef COMBINED_LOOP_FUNCTIONS_H
#define COMBINED_LOOP_FUNCTIONS_H
...
class CCombinedLoopFunctions : public CLoopFunctions {

public:

   CCombinedLoopFunctions();
   virtual ~CCombinedLoopFunctions() {}
