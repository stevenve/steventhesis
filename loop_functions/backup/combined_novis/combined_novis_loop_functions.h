#ifndef COMBINED_NOVIS_LOOP_FUNCTIONS_H
#define COMBINED_NOVIS_LOOP_FUNCTIONS_H
...
class CCombinedNoVisLoopFunctions : public CLoopFunctions {

public:

   CCombinedNoVisLoopFunctions();
   virtual ~CCombinedNoVisLoopFunctions() {}
