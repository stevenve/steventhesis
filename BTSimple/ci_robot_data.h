...
#include "ci_behavior.h"
#include "ci_behavior_controller.h"
#include "ci_robot_data.h"
...
namespace argos {
    ...
    typedef std::map<const std::string, argos::CAny> TAnyPropertyMap;
    ...
    template<class TRobotState> class CCI_RobotData {
        ...
        public:
             ...
             */
            CCI_RobotData(CCI_Controller* pc_controller2,		//TODO da was robot, is dees nog nodig of ga ook via pc_contorller?
